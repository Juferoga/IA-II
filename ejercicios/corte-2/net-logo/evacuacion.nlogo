...
to mover
  ...
  if [pcolor] of patch-at 0 1 != white [ set posibles-direcciones lput patch-at 0 1 posibles-direcciones ]
  if [pcolor] of patch-at 0 -1 != white [ set posibles-direcciones lput patch-at 0 -1 posibles-direcciones ]
  if [pcolor] of patch-at 1 0 != white [ set posibles-direcciones lput patch-at 1 0 posibles-direcciones ]
  if [pcolor] of patch-at -1 0 != white [ set posibles-direcciones lput patch-at -1 0 posibles-direcciones ]

  let parche-valido one-of posibles-direcciones
  if parche-valido != nobody [
    move-to parche-valido
  ]
end
@#$#@#$#@
GRAPHICS-WINDOW
